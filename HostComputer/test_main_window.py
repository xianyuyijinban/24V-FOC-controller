...
from data_parser import CurrentSample, FOCDataPacket
...
class TestHostMainWindow(unittest.TestCase):
    ...
    def test_current_stream_toggle_starts_recommended_binary_scope(self):
        ...
        self.assertIn("TELEM:CUR,BIN,1000\n", commands)
    ...
    def test_current_stream_mode_change_starts_scope_when_enabled(self):
        ...
        self.assertTrue(window._scope_enabled)
        self.assertIn("TELEM:CUR,ASCII,200\n", commands)
    ...
    def test_app_power_buttons_use_enable_state_machine(self):
        ...
        self.assertEqual(commands, ["CMD:UNLOCK,1\n", "CMD:STALL_MODE,1\n", "CMD:ENABLE,1\n"])
    ...
    def test_hold_panel_status_uses_runtime_telemetry(self):
        ...
        self.assertIn("APP HOLD", window.advanced_mode_value.text())
        self.assertIn("CTRL", window.advanced_mode_value.text())
        self.assertIn("位置", window.advanced_mode_value.text())
