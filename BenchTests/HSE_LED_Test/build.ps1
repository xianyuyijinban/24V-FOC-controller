...
$TARGET = "hse_led_test"
# Output artifact: hse_led_test.elf
...
Compile-SourceGroup "Compiling Standalone HSE LED Test C Sources" $C_SOURCES "CC" $CFLAGS
Compile-SourceGroup "Compiling Standalone HSE LED Test ASM Sources" $ASM_SOURCES "AS" $ASFLAGS
